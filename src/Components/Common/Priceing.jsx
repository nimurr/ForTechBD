    ...
    <div className="">
      ...
      <div className="grid xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-10 bg-gray-100 flex-wrap">
        {pricingPlans.map((plan, index) => (
          <div
            key={index}
            className={`w-full relative p-6 pb-10 border border-gray-300 rounded-lg bg-white text-center shadow-lg sm:hover:scale-105 duration-300 ${plan?.big && 'sm:scale-110'}`}
          >
            <img
